...
import { agentBehavior, agentConfig, agentInstructions, buildInstructions, skills } from './util.js';

describe('util', () => {
  it('should export agent config object', () => {
    assert.ok(agentConfig);
    // provider and documentationUrl are optional — only assert shape if present
